      ...
      >
        ...
        <div className="flex flex-col gap-1.5 text-left">
          ...
          <input
            ...
            className="w-full bg-zinc-950/50 border border-zinc-800/80 rounded-xl px-4 py-3 text-zinc-200 placeholder-zinc-600 focus:outline-none focus:border-violet-500/60 focus:ring-1 focus:ring-violet-500/30 transition-all duration-300"
            required
          />
        </div>
        ...
        <div className="flex flex-col gap-1.5 text-left">
          ...
          <textarea
            ...
            rows={4}
            className="w-full bg-zinc-950/50 border border-zinc-800/80 rounded-xl px-4 py-3 text-zinc-200 placeholder-zinc-600 focus:outline-none focus:border-violet-500/60 focus:ring-1 focus:ring-violet-500/30 transition-all duration-300 resize-none animate-none"
            required
          />
        </div>
